...
--------------------------------------------------------------------------------
-- 5. GUI swatch sprites
--------------------------------------------------------------------------------

-- The color picker's preset swatches are sprite-buttons, and LuaGuiElement has
-- no runtime tint, so each preset needs its own tinted sprite prototype: a
-- plain white 10x10 square from core, tinted at the data stage.
--
-- Keep this list in sync with PRESETS in scripts/gui.lua (the two stages can't
-- share a require).
local PRESET_COLORS = {
...
for name, color in pairs(PRESET_COLORS) do
  data:extend {{
    type = "sprite",
    name = mod_name .. "-swatch-" .. name,
